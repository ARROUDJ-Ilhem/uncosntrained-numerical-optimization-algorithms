...
def main():
    ...
    paths = {
        'Gradient Descent Fixed': gradient_descent_fixed_step(func, grad_func, x0, learning_rate, max_iter),
        'Gradient Descent Variable': gradient_descent_variable_step(func, grad_func, x0, learning_rate, max_iter=max_iter),
        'Newton\'s Method': newtons_method(func, grad_func, hessian_func, x0, max_iter=max_iter),
        'Quasi-Newton (BFGS)': quasi_newtons_method(func, grad_func, x0, max_iter=max_iter),
        'Nesterov Accelerated Gradient': nesterov_accelerated_gradient(func, grad_func, x0, learning_rate, max_iter=max_iter)
    }
